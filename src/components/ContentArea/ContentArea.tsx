...
import { getDefaultResumeDetails, getTestResumeDetails, type ResumeDetails } from '../../data/resumeDetails';
...
const ContentArea: FC = () => {
  ...
  const updateField = (fieldName:String, fieldData:String) => {
  ...
  return(
    <Grid className={styles.ContentArea} size="grow">
      ...
      {/* <Grid className={`${styles.detailsArea}`}>
        <Grid container>
          <Grid size={6} sx={{padding:'20px 30px'}}>
            <TextField label="FIRST NAME" variant="outlined" fullWidth required value={resumeState.firstName}
              onChange={(e) => updateField("firstName", e.target.value)}
              />
          </Grid>
          <Grid size={6} sx={{padding:'20px 30px'}}>
            <TextField label="LAST NAME" variant="outlined" fullWidth required value={resumeState.lastName}
        ...
        <Grid container>
          ...
          <Grid size={6} sx={{padding:'20px 30px'}}>
            <TextField label="EMAIL" variant="outlined" fullWidth required value={resumeState.email}
      ...
      {/* <Grid className={`${styles.detailsArea}`}>
        <Grid container>
          <Grid size={6} sx={{padding:'20px 30px'}}>
            <TextField label="FIRST NAME" variant="outlined" fullWidth required value={name}
      ...
      <Card className={`${styles.actionButtons}`}>
        ...
        <Button variant="outlined" color='secondary' sx={{marginRight:'0.5rem'}}>
          <FontAwesomeIcon icon={faBroom} />
            &nbsp;Clear</Button>
        <Button variant="outlined" color='primary' sx={{marginRight:'0.5rem'}}>
          <FontAwesomeIcon icon={faCloudArrowUp} />
            &nbsp;Upload
          </Button>
        <Button variant="outlined" color='primary' onClick={() => navigate("/template1", { state: getTestResumeDetails() })}>
